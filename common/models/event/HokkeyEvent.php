...
/**
 * Created by PhpStorm.
 * @method \common\sport\ratio\Hokkey getNewRatio()
 * @method \common\sport\ratio\Hokkey getOldRatio()
 * @method \common\sport\result\Hokkey getResult()
 * @method \HokkeyEvent copy()
 */
class HokkeyEvent extends SportEvent implements iSportEvent
{
    /**
    ...
    public function init()
    {
        ...
        $this
            ->setOldRatio(new \common\sport\ratio\Hokkey())
            ->setNewRatio(new \common\sport\ratio\Hokkey())
            ->setResult(new \common\sport\result\Hokkey());
    }
    ...
    public function defaultScope()
    {
        ...
        return [
            ...
            'params' => [':'.$t.'sport_type' => SportHelper::SPORT_HOKKEY_ID]
        ];
    }
    ...
    public function beforeValidate()
    {
        ...
        $this->sport_type = SportHelper::SPORT_HOKKEY_ID;
