 ...
 * Created by PhpStorm.
 */
class Basketball extends Base implements iRatio, iRatioHomepage, iProblemForaWin, iProblemFora
{
    /** @var float */
    protected $ratio_1x;
    /** @var float */
    ...
    public function isTotalHint()
    {
        ...
        $RatioFactory = RatioFactory::factory(SportHelper::SPORT_BASKETBALL_ID, 'total_more');
        return $RatioFactory
    ...
    public function isFora1Hint()
    {
        ...
        $RatioFactory = RatioFactory::factory(SportHelper::SPORT_BASKETBALL_ID, 'fora_ratio_1');
    ...
    public function isFora2Hint()
    {
        ...
        /** @var BaseFora $RatioFactory */
        $RatioFactory = RatioFactory::factory(SportHelper::SPORT_BASKETBALL_ID, 'fora_ratio_2');
