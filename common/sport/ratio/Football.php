 ...
 * Created by PhpStorm.
 */
class Football extends Base implements iRatio, iRatioHomepage, iProblemForaWin, iProblemFora
{
    /** @var float */
    protected $ratio_1x;
    /** @var float */
    ...
    public function isTotalHint()
    {
        ...
        $RatioFactory = RatioFactory::factory(SportHelper::SPORT_FOOTBALL_ID, 'total_more');
        return $RatioFactory
    ...
    public function isFora1Hint()
    {
        ...
        $RatioFactory = RatioFactory::factory(SportHelper::SPORT_FOOTBALL_ID, 'fora_ratio_1');
    ...
    public function isFora2Hint()
    {
        ...
        /** @var BaseFora $RatioFactory */
        $RatioFactory = RatioFactory::factory(SportHelper::SPORT_FOOTBALL_ID, 'fora_ratio_2');
