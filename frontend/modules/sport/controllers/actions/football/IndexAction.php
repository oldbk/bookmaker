<?php
namespace frontend\modules\sport\controllers\actions\football;
...
class IndexAction extends CAction
{
    public function run()
    {
        ...
        $pages = new \CPagination(\FootballEvent::model()->count($criteria));
        $pages->pageSize = 15;
        ...
        $this->getController()->setPageTitle('Футбол');
