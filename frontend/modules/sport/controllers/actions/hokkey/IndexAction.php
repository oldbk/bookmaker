<?php
namespace frontend\modules\sport\controllers\actions\hokkey;
...
class IndexAction extends CAction
{
    public function run()
    {
        ...
        $pages = new \CPagination(\HokkeyEvent::model()->count($criteria));
        $pages->pageSize = 15;
        ...
        $this->getController()->setPageTitle('Хоккей');
