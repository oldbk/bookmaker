<?php
namespace frontend\modules\sport\controllers\actions\tennis;
...
class IndexAction extends CAction
{
    public function run()
    {
        ...
        $pages = new \CPagination(\TennisEvent::model()->count($criteria));
        $pages->pageSize = 15;
        ...
        $this->getController()->setPageTitle('Теннис');
