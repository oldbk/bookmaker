...
?>
    ...
    <td>
        ...
        <span
            class="pointer editable"
            data-name="ratio_plus15_1"
            data-url="<?= Yii::app()->createUrl('/admin/event/ratio', ['event_id' => $Event->getId()]); ?>">
            <?= $DataToView->getRatioPlus151(); ?></span>
            <?= $Event->upDown('ratio_plus15_1'); ?>
        </div>
        <div class="ratio">
        <span
            class="pointer editable"
            data-name="ratio_plus15_2"
            data-url="<?= Yii::app()->createUrl('/admin/event/ratio', ['event_id' => $Event->getId()]); ?>">
            <?= $DataToView->getRatioPlus152(); ?></span>
