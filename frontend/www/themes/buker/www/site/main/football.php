...
<table data-type="event-line" class="table list head-sticker" id="bet-list">
    ...
    <tbody>
    <tr class="head-title hover">
        <td colspan="6" class="sport-event-title">
            Чемпионат мира 2018. Групповой этап. Россия
        </td>
    </tr>
<?php foreach ($WC18 as $model): ?>
	<?php $DataToView = \common\factories\DataToViewFactory::factory($model->getSportType(), ['Event' => $model]);
...
<table data-type="event-line" class="table list head-sticker" id="bet-list">
    ...
    <tbody>
    <tr class="head-title hover" style="background-color: #e0dbc2 !important;">
        <td colspan="6" class="sport-event-title">
            Ближайшие события
        </td>
    </tr>
